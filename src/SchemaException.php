...
final class SchemaException extends LogicException implements ExceptionInterface
{
    ...
    // primary key
    const PRIMARY_KEY_DUPLICATED_COLUMN        = 5000;

    // unique key
    const UNIQUE_KEY_DUPLICATED_COLUMN         = 6000;

    // index
    const INDEX_INVALID_NAME                   = 7000;
    const INDEX_DUPLICATED_COLUMN              = 7001;

    // foreign key
    const FOREIGN_KEY_DUPLICATED_CHILD_COLUMN  = 8000;
    const FOREIGN_KEY_DUPLICATED_PARENT_COLUMN = 8001;
    const FOREIGN_KEY_MORE_CHILD_COLUMN        = 8002;
    const FOREIGN_KEY_MORE_PARENT_COLUMN       = 8003;
    const FOREIGN_KEY_INVALID_UPDATE_RULE      = 8004;
    const FOREIGN_KEY_INVALID_DELETE_RULE      = 8005;
